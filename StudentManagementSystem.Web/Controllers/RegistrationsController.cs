...
namespace StudentManagementSystem.Web.Controllers
{
    ...
    {
        private smsDotNETEntities db = new smsDotNETEntities();
        ...
        public ActionResult Create([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id,telephone")] registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,firstname,lastname,nic,course_id,batch_id,telephone")] registration registration)
        {
            if (ModelState.IsValid)
            {
